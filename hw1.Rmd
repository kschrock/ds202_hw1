...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello Everyone, My name is **Kordell Schrock** and I am a rising Junior studying *Software Engineering* with a Minor in *Data Science*. I have done research **@ Stanford University** in the HCI Department last summer and this summer I completed the **Dartmouth ASURE** program. Also I did a mini-internship with Leidos.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I watched a Netflix Documentary about Cambridge Analytica which used Data Science to manipulate voter's votes in the 2016 presidential elections. The Documentary is called **'The Great Hack'**. This job would be data-mining people's data from Social Media platforms. Then use Algo's to deteremine how to change people votes through different strategic campaigns. <https://en.wikipedia.org/wiki/Cambridge_Analytica> 
```{r, out.width = "450px"}
#knitr::include_graphics("https://bluenote.world/uploads/content/_1200x1200_fit_center-center_85_none/pic-1.png")
```
    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: Currently, I am really intresting in Blockchain Projects. I have followed Bitcoin and Ethereum for a few years now. The project I am looking at right now is called Ampleforth. Ampleforth is a new project that started about 1 year ago that used Defi protocols to manage elastic money. This is revolutionary because it is elastic due to the market supply rebasing every 24 hours depending on Market Cap.  
...
10. Register a [GitHub](https://www.github.com) account. What is your username?
    ...
    Answer: **kschrock** <https://github.com/kschrock>